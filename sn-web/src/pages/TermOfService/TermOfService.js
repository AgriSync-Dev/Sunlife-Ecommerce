...
const TermOfService = () => {
	...
	return (
		<Container style={{ width: containerWidth }}>
			<Row>
				<Col className=" my-5  d-flex justify-content-center text-dark" style={{ fontFamily: "Anton" }}>
					<h2>
			...
			<div className="container">
				<div>
					...
					<p>
						Refunds will only be issued if and when the items you wish to refund are returned unopened and
						undamaged. Refund process will start once we receive the returned items
					</p>
					<p>OVERVIEW</p>
					<p>
						This website is operated by THE SNUS LIFE LIMITED. Throughout the site, the terms “we”, “us” and
						“our” refer to THE SNUS LIFE LIMITED. THE SNUS LIFE LIMITED offers this website, including all
					...
					<p>
						...
						requirements of connecting networks or devices. Credit card information is always encrypted
					...
					<p>
						...
						service is provided, without express written permission by us. The headings used in this
					...
					<p>
						...
						to modify or discontinue the Service (or any part or content thereof) without notice at any
						time. We shall not be liable to you or to any third-party for any modification, price change,
					...
					<p>
						...
						offer for any product or service made on this site is void where prohibited. We do not warrant
						that the quality of any products, services, information, or other material purchased or obtained
					...
					<p>
						...
						optional third-party tools. Any use by you of optional tools offered through the site is
						entirely at your own risk and discretion and you should ensure that you are familiar with and
						approve of the terms on which tools are provided by the relevant third-party provider(s). We may
						also, in the future, offer new services and/or features through the website (including, the
					...
					<p>
						...
						third-party websites. Please review carefully the third-party's policies and practices and make
					...
					<p>
						...
						use of the service will be accurate or reliable. You agree that from time to time we may remove
						the service for indefinite periods of time or cancel the service at any time, without notice to
						you. You expressly agree that your use of, or inability to use, the service is at your sole
						risk. The service and all products and services delivered to you through the service are (except
					...
					<p>
						In no case shall THE SNUS LIFE LIMITED, our directors, officers, employees, affiliates, agents,
					...
					<p>
						You agree to indemnify, defend and hold harmless THE SNUS LIFE LIMITED and our parent,
					...
					<p>
						...
						survive the termination of this agreement for all purposes. These Terms of Service are effective
						...
						site. If in our sole judgment you fail, or we suspect that you have failed, to comply with any
					...
					<p>Questions about the Terms of Service should be sent to us at info@thesnuslife.com</p>
				</div>
			</div>
		</Container>
	);
