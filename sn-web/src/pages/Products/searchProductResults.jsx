...
const Sort = () => {
  return (
    <span className=" mr-2" style={{ color: "gray" }}>
      {" "}
      SORT BY{" "}
    </span>
  );
...
const SearchProductResults = () => {
  ...
  const getAllProducts = async (sortByPrice, sort) => {
    try {
      const response = await apiGET(
        `/v1/products/get-all-products?filter[query]={search:${search},brand:${brand},pots:${numberOfPots},productType:${productTypeName},strength:${strength},flavor:${flavourName}}&sort[${
          sort || "name"
      ...
      if (response?.status === 200) {
        //console.log(response?.data?.data?.data,'satyam',maxPrice)
  ...
  useEffect(() => {
    ...
    window.scrollTo(0, 0);
  }, [page, brand, search, flavourName, numberOfPots, productTypeName]);
  ...
  let fetchSiteMetadata = async () => {
    try {
      let res = await apiGET(
        `/v1/site-metadata/get-site-metadata-by-type?type=shop page discription`
      );
    ...
    <>
      <div>
        <Helmet>
          <meta
            name="description"
            content={
              metaData?.length ? metaData : "Shop our 450+ exiting flavours !"
            }
          />
        </Helmet>
      </div>
      <div className="main-container">
        <div className=" d-flex justify-content-center  text-center p-4 ">
          <div
            className=" fs-3  mt-4  container p-0  searchBoxpaddingleft"
            style={{ width: "100%" }}
          >
            ...
            <div
              className=""
              style={{ fontSize: "14px", marginTop: "5px", textAlign: "left" }}
            >
              {productCount
                ? `${productCount} items found for "${search}" `
                : ""}
            </div>
          </div>
        </div>
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{ height: 400, minWidth: "250px", overflowY: "auto" }}
                >
                  {catogry &&
                    catogry?.map((item) => {
                      return (
                        <div
                          ...
                          className={` ${
                            item?._id == brand ? "avenir-medium" : "avenir"
                          } thumbnail`}
              ...
              >
                ...
                >
                  <div
                    style={{ cursor: "pointer" }}
                    className={`${
                      brand == "All" || brand == "" ? "avenir-medium" : "avenir"
                    } thumbnail`}
                    onClick={() => setBrand("")}
                  >
                    {" "}
              ...
              >
                ...
                >
                  <div
                    style={{ cursor: "pointer" }}
                    className={`${
                      productTypeName == "All" || productTypeName == ""
                        ? "avenir-medium"
                        : "avenir"
                    } thumbnail`}
                    ...
                    ? productType?.map((item) => {
                        return (
                          <div
                            ...
                            onClick={() =>
                              handlebyProductType(item?.productType)
                            }
                          >
                            {item?.productType}
                          </div>
            ...
            <ul className="pagination">
              ...
              <li className="page-item">
                <span
                  ...
                  style={{
                    background: `${page == totalPages ? "#f5f5f5" : ""} `,
                  }}
                >
